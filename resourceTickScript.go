...
import (
	...
	//import "github.com/hashicorp/terraform/builtin/providers/influxdb"
	kapacitorClient "github.com/influxdata/kapacitor/client/v1"
)

func resourceTickScript() *schema.Resource {
	return &schema.Resource{
		Create: resourceTickScriptCreate,
		Read:   resourceTickScriptRead,
		Update: resourceTickScriptUpdate,
		Delete: resourceTickScriptDelete,
		Schema: map[string]*schema.Schema{
			"id": &schema.Schema{
				Type:     schema.TypeString,
				Computed: true,
			},
			"tick_script": &schema.Schema{
				Type:     schema.TypeString,
				Required: true,
			},
			"type": &schema.Schema{
			...
			"database_retention_policies": &schema.Schema{
...
func resourceTickScriptCreate(data *schema.ResourceData, meta interface{}) error {
	...
	return resourceTickScriptRead(data, meta)
}

func resourceTickScriptRead(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
...
func resourceTickScriptUpdate(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
...
func resourceTickScriptDelete(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
